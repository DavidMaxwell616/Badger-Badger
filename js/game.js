...
class Example extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('snake', 'snake.png', { frameWidth: 300, frameHeight: 240 });
...
function createBadger(scene) {
  ...
  scene.anims.create({
    key: 'badgerDance' + numBadgers + badgerIndex,
  ...
  badger.anims.play('badgerDance' + numBadgers + badgerIndex);
